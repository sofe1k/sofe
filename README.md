...
git clone https://github.com/sofe1k/sofe.git
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf sofe && rm -rf .telegram-cli && git clone https://github.com/sofe1k/sofe.git && ./launch.sh install && ./launch.sh
~~~~~
